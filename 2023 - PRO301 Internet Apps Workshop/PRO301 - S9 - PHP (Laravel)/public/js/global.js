...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    // Check if #current-date and #current-time exists
    if (document.querySelector('#current-date') !== null || document.querySelector('#current-time') !== null) {
...
function loadSite() {
    ...
    if (category !== null) {
        ...
        categoryName();
    } else if (document.querySelector('.index') !== null || document.querySelector('.category') !== null) {
    ...
    } else if (document.querySelector('.classifieds') !== null) {
    ...
    let defaultArticles = [
        {
            ...
            image: site_url + '/images/129177060_230327_077-credit-trustees-of-the-nhm-london.jpg',
            content: '<p>A colossus has landed in London: A cast of what was one of the biggest animals ever to walk the Earth is now on show at the Natural History Museum.</p><p>Patagotitan was a dinosaur that lived 100 million years ago in South America.</p><p class="video"><video controls><source src="' + site_url + '/videos/all-over-in-10-seconds.mp4" type="video/mp4">Tu navegador no soporta el elemento video. Descarga el video <a href="' + site_url + '/videos/all-over-in-10-seconds.mp4">aquí</a>.</video></p><p>The museum has brought over not just a representative skeleton but some of the real fossil bones first discovered in Argentina in 2014. The largest is a 2.4m-long femur, or thigh bone. It\'s been erected upright to give visitors an extraordinary selfie opportunity.</p>',
            source_name: 'BBC',
...
function loadArticles(category = 'news') {
    ...
    // If #articles-gallery doesn't exist, return and do nothing
    if (document.querySelector('#articles-gallery') === null) {
        return false;
    }
    ...
    articles.forEach(function (article) {
        ...
        outputHtml = interpolate(outputHtml, {
            ...
            link: site_url + '/article?article_id=' + article.id
        });
...
function loadClassifieds(category = 'sell') {
    ...
    classifieds.forEach(function (classified) {
        ...
        outputHtml = interpolate(outputHtml, {
            ...
            link: site_url + '/classified/?classified_id=' + classified.id
        });
...
function categoryName() {
    ...
    // If category_name = Inicio, hide #breadcrumb
    if (category_name === 'Inicio') {
